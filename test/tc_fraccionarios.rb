...
class Test_Fraciones < Test::Unit::TestCase
	...
	def setup
	   @racional1 = Fraccionarios.new(3,2) 
	...
	def test_simple 
		assert_equal("3/2", @racional1.to_s)
	...
	def test_multiplicacion 
		assert_equal("3/4",(@racional1 * @racional2).to_s)
	end

	def test_division
	   assert_equal("3/1",(@racional1 / @racional2).to_s)
	end

	def test_suma 
	   assert_equal("2/1",(@racional1 + @racional2).to_s)
	end
